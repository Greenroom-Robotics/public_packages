...
sudo curl -sSL https://raw.githubusercontent.com/Greenroom-Robotics/public_packages/main/debian/keyring.asc -o /etc/apt/trusted.gpg.d/greenroom-robotics-public-packages-keyring.asc
